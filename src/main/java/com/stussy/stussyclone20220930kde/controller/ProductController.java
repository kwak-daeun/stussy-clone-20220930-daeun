...
import com.stussy.stussyclone20220930kde.dto.CheckoutRespDto;
...
public class ProductController {
    ...
    public String loadPayment(Model model,
                              ...
                              @AuthenticationPrincipal PrincipalDetails principalDetails) throws  Exception{ //model객체를 쓰면 dto를 안써도됨
