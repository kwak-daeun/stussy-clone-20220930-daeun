...
public class RestControllerExceptionHandler {
    ...
    @ExceptionHandler(CustomValidationException.class) //이 클래스 예외가 일어났다 핸들러로 잡아줌 , 예외가 발생한 객체
    public ResponseEntity<?> validationErrorException(CustomValidationException e){ // 예외를 던져줌 e라는 매개변수 생김
